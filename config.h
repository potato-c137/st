...
static char *font2[] = { "Iosevka:pixelsize=15:antialias=true:autohint=true" };
...
static MouseShortcut mshortcuts[] = {
	...
	{ XK_NO_MOD,            Button4, kscrollup,      {.i = 1.5} },
	{ XK_NO_MOD,            Button5, kscrolldown,    {.i = 1.5} },
